function generateStory() {
    ...
    const noun = form.elements['noun'].value || "&lt;missing text&gt;"; //instead of <missing text>
    ...
    var res = str.replace(new RegExp("&lt;missing text&gt;", 'g'), "<span style='color:red'>&lt;missing text&gt;</span>"); //use replace to change color of rendered "<missing text>"
